...
//     axios.get('/api/profile')
//       .then(res => {
//         const { user: u, student: s } = res.data.data;
//         setProfile(u);
//         setStudent(s);
//         setEditForm({
//           name:     u.name || '',
...
//         <div>
//           <h1 className="page-title">My Profile</h1>
//           <p className="page-sub">Manage your account and settings</p>
//         </div>
//         <span style={{
...
//                 )}
//                 {student.github && (
//                   <a href={student.github} target="_blank" rel="noreferrer" className="btn btn-sm btn-outline-dark">
...
//                   <span style={{ marginLeft: 'auto', fontSize: '0.62rem', background: '#dcfce7', color: '#166534', padding: '2px 8px', borderRadius: 10, fontWeight: 700 }}>
//                     ✓ Done
//                   </span>
//                 )}
//                 {/* Placed badge */}
...
//                       Email <span style={{ color: '#94a3b8', fontWeight: 400, fontSize: '0.72rem' }}>(cannot change)</span>
//                     </label>
...
//                     You have view-only access to placement data. If you are a student,
//                     contact your placement admin to link your student profile for full access.
//                   </p>
//                 </div>
//               )}
//             </div>
...
//                       <div style={{ fontFamily: 'Syne,sans-serif', fontWeight: 800, fontSize: '1.15rem', color: item.color || '#1e293b', lineHeight: 1 }}>
//                         {item.v}
//                       </div>
//                       <div className="metric-lbl">{item.l}</div>
//                     </div>
...
//                 </div>
//               ) : (
//                 <div className="text-center p-4 mb-4" style={{ background: '#fef9c3', borderRadius: 12, border: '1px solid #fde68a' }}>
//                   <i className="bi bi-file-earmark-x" style={{ fontSize: '3.5rem', color: '#d97706' }}></i>
//                   <h6 style={{ marginTop: 12, color: '#92400e' }}>No resume uploaded yet</h6>
//                   <p style={{ fontSize: '0.8rem', color: '#78350f', margin: 0 }}>Upload your resume so recruiters can access it</p>
//                 </div>
//               )}
...
//                   }}>
//                     {uploading ? 'Please wait...' : 'Choose PDF File'}
//                   </span>
//                   <input type="file" accept=".pdf" style={{ display: 'none' }}
//                     onChange={handleResumeUpload} disabled={uploading} />
//                 </div>
...
//                           <div style={{ fontSize: '0.65rem', color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 4 }}>
//                             <i className={`bi ${item.icon} me-1`}></i>{item.l}
//                           </div>
//                           <div style={{ fontWeight: 700, fontSize: '0.9rem', color: '#1e293b' }}>{item.v}</div>
//                         </div>
//                       </div>
//                     ))}
//                   </div>
...
//               ) : (
//                 // Not placed
//                 <div className="text-center py-5" style={{ background: '#f8fafc', borderRadius: 12, border: '2px dashed #e2e8f0' }}>
//                   <i className="bi bi-briefcase" style={{ fontSize: '3rem', color: '#cbd5e1' }}></i>
...
//                     <label className="form-label">New Password</label>
//                     <div style={{ position: 'relative' }}>
//                       <i className="bi bi-key" style={{ position: 'absolute', left: 12, top: '50%', transform: 'translateY(-50%)', color: '#94a3b8' }}></i>
//                       <input type="password" className="form-control" style={{ paddingLeft: 36 }}
...
//                     <label className="form-label">Confirm New Password</label>
//                     <div style={{ position: 'relative' }}>
//                       <i className="bi bi-key-fill" style={{ position: 'absolute', left: 12, top: '50%', transform: 'translateY(-50%)', color: '#94a3b8' }}></i>
//                       <input type="password" className="form-control" style={{ paddingLeft: 36 }}
...
//                     {/* Match indicator */}
//                     {pwForm.confirmPassword && (
//                       <div style={{ fontSize: '0.72rem', marginTop: 5, fontWeight: 600,
//                         color: pwForm.newPassword === pwForm.confirmPassword ? '#059669' : '#dc2626' }}>
...
//                 <div style={{ marginTop: 12, padding: '10px 14px', background: '#f8fafc', borderRadius: 8, fontSize: '0.75rem', color: '#64748b' }}>
